...
<html lang="en">
  ...
  <div class="container">
    ...
    <div class="col-8">
    Nama Pengguna : Pengguna 1 
    <br>
    <br>
    Email Pengguna : emailpengguna1@gmail.com
    <br>
    <br>
    No telp : 08987654321
    <br>
    <br>
    <a class="btn btn-dark" href="editprofile.php" role="button" style="background-color : #9F2E32; ">Edit Profile</a>
    </div>
  </div>
